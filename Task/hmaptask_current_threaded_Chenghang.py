...
class task_flag:
	'''
	This is a fake task class that help old task file to incoporate sit_still task. 
	Or any other subthread tasks. 
	'''
	def __init__(self):
		self._running = True
...
def RunSet(app):
	...
	#Process the monitor thread: 
	my_taskflag = task_flag()
	sit_still_task = sit_still_class(my_taskflag,app)
